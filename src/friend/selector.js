...
export const getFriendsWithAgeShowLimit = createSelector(getFriendsWithAgeLimit, getShowLimit, (friendsWithAgeLimit, showLimit) => friendsWithAgeLimit.slice(0, showLimit));
